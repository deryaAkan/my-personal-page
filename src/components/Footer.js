    ...
    return (
        <footer className='CommonThings bg-white text-[#777777] gap-5 dark:bg-[#252128]'>
            <div className='w-1/2 flex flex-col justify-center items-center gap-5'>
                <h3 className='font-bold text-[#4731D3] text-[48px] dark:text-[#8F88FF]'>Send me a message!</h3>
                <p className='w-[400px] font-normal text-[24px] dark:text-white'>Got a question or proposal, or just want to say hello? Go ahead.</p>
                <a className='text-[20px] text-[#4731D3] underline dark:text-[#8F88FF]'>almilasucode@gmail.com</a>
